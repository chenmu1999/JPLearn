...
- `database-design.md`：第一版数据模型的唯一实现依据，包含 Prisma/SQLite 模型、关系、约束、索引和导入策略。
...
- `vocabulary-module-design.md`：参考百词斩学习闭环的独立单词模块、分维度掌握、复习调度和付费 AI 个性化例句实现方案。
- `vocabulary-module-execution-plan.md`：单词模块的里程碑、任务依赖、目录落点、数据导入、判题、复习、AI 权益和 Ubuntu 验收执行清单。
